...
export default function Home() {
  ...
  return (
    <div>
      <header className="flex  flex-wrap sm:justify-start  sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 h-14 sm:py-0 dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-[-20px] flex justify-center">
            <a className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:hover:border-neutral-600 dark:text-neutral-200"
              href="https://ikaranpatel.vercel.app/" target="_blank">
              Made with 💙 by Karan Patel
          ...
          <div className="mt-8 mb-[-40px] gap-3 flex justify-center">
            {user?.user?.email ?
